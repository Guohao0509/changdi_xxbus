    ...
    function ($stateProvider,   $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('app.user.add', {
                //跳转到用户添加页面
                url: '/add',
                templateUrl: basePath+'user/edit.html',
                ncyBreadcrumb: {
                    parent:'app.user.user_list',
                    label: '添加用户'
                }
            })
            .state('app.user.edit', {
            ...
            .state('app.user.adds', {
                //跳转到用户添加页面
                url: '/adds',
                templateUrl: basePath+'user/adds.html',
                ncyBreadcrumb: {
                    parent:'app.user.user_list',
                    label: '批量添加用户'
                }
            ...
            .state('app.company', {
                ...
                resolve: {
                    deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                            //延迟加载授权控制器
                            return $ocLazyLoad.load(basePath+'company/controller.js');
                        }]
                }
            })
            .state('app.company.list', {
                //跳转到司机详情界面
                url: '/list',
                templateUrl: basePath+'company/list.html',
                ncyBreadcrumb: {
                    parent:'app.dashboard',
                    label: '单位管理'
                }
            ...
            .state('app.company.add', {
                url: '/add',
                templateUrl: basePath+'company/add.html',
                ncyBreadcrumb: {
                    parent: 'app.dashboard',
                    label: '添加单位'
                }
